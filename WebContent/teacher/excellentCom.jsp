...
<div id="wrapper">
  ...
  <s:property value="#request.haveFavorite"/></h2>
				...
				<div class="entry">
					<p><s:form action="excellent">
  	<s:textarea id="content1" name="content" cols="90" rows="30" wrap="ture" key="favoriteCom" value="%{#request.comment.comments}"></s:textarea>
  	<s:hidden name="tid" value="%{#parameters.tid}"></s:hidden>
  	<s:hidden name="eid" value="%{#request.comment.eid}"></s:hidden>
