	...
	<div id="page-bgbtm">
        ...
        <!--repeat this part below-->
			...
			<div class="post-bgbtm">
				<h2 class="title"><s:text name="edit"></s:text>/<s:text name="layTeam"></s:text></h2>
				<p class="meta">Click the Names Listed to View the Status of Teams. </p>
				
				<div class="entry">
	<p><s:iterator id="data" value="#request.exname">
    	<s:url id="url" action="dateTeam">
    	...
    	<s:action name="dateTeam2" executeResult="true">
    		<s:param name="enid" value="#data.enid"></s:param>
    	</s:action>
    </s:iterator>
    </p>
