...
// Source File Name:   BenTResultAction.java
...
public class BenTResultAction extends ActionSupport
{

    public BenTResultAction()
    {
    }
    ...
    public String execute()
    {
        ...
        List dataList = (new BenData()).getBenTemperData(team.getTid().intValue());
        BenResModel model;
        ...
        ActionContext.getContext().put("benT", benTRes);
        ActionContext.getContext().put("benT2", benTRes);
        return "success";
    }
